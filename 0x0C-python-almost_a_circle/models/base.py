...
class Base:
	"""represents the base model
		...
		represents the base for all other classes in 0x0C
	...
	def from_json_string(json_string):
		...
		"""
		if json_strin is None or json_string == "[]":
			return []
	...
	def load_from_file(cls):
		"""return list of clsses instatiated from a file of JSON strings

			reads from `<cls.__name__>.json`.

			Returns:
			if the file does not exit - empty list
	...
	@staticmethod
	def draw(ist_rectangles, list_squares):
